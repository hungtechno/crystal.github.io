b4w.register("crystal_main",function(v,d){function w(a,c){c?(t.create_preloader(),a.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1},x.load(y+"crystal.json",z,A)):console.log("b4w init failure")}function A(a){t.update_preloader(a)}function z(a,c){c?(m.enable_camera_controls(),m.enable_camera_controls(!1,!1,!1,null,!0),a=h.get_active_camera(),B(a),a=C.get_canvas(),a.addEventListener("mouseup",D),a.addEventListener("mousedown",E)):console.log("b4w load failure")}function D(a){if(0==
a.button){a.preventDefault&&a.preventDefault();if(a=h.pick_object(a.clientX,a.clientY))switch(h.get_object_name(a)){case "nutquaylai":var d=h.get_object_by_name("target1"),g=h.get_object_by_name("vitri1");break;default:return}g&&d&&(a=h.get_active_camera(),g=l.get_translation(g),d=l.get_translation(d),r.target_get_pivot(a,c.current_target),l.get_translation(a,c.current_eye),k.copy(c.current_target,c.starting_target),k.copy(c.current_eye,c.starting_eye),k.copy(g,c.final_eye),k.copy(d,c.final_target),
n=1,c.timeline=F.get_timeline(),console.log(c))}}function E(a){0==a.button&&(a=h.get_active_camera(),1>g.get_sensor_value(a,"CAMERA_MOVE",0)-c.timeline&&(p=!0))}function B(a){var d=g.create_timeline_sensor(),h=g.create_elapsed_sensor();g.create_sensor_manifold(a,"CAMERA_MOVE",g.CT_CONTINUOUS,[d,h],function(a){return 1>a[0]-c.timeline},function(a,b,d){1==d?p?c.timeline=-1:(m.disable_camera_controls(),b=g.get_sensor_value(a,b,1),d=b/1,k.subtract(c.final_eye,c.starting_eye,q),k.scaleAndAdd(c.current_eye,
...
!1);a=document.getElementById("tongquancrystal");a.style.display="block";a.addEventListener("click",function(){e.style.bottom="0px";f.style.top="45%";b.style.display="none";document.getElementById("noidungthongtin").src="./assets/webcon-crystal/crystal-tongquan.html";document.getElementById("audio1").src="./assets/crystal-audio/crystal-tongquan.mp3";b.style.display="block"==b.style.display?"none":"block"},!1);a=document.getElementById("sodomatbang");a.style.display="block";a.addEventListener("click",
function(){e.style.bottom="0px";f.style.top="45%";b.style.display="none";document.getElementById("noidungthongtin").src="./assets/webcon-crystal/sodomatbang/sodomatbang.html";document.getElementById("audio1").src="./assets/crystal-audio/crystal-tongquan.mp3";b.style.display="block"==b.style.display?"none":"block"},!1);a=document.getElementById("chinhsachbanhang");a.style.display="block";a.addEventListener("click",function(){e.style.bottom="0px";f.style.top="45%";b.style.display="none";document.getElementById("noidungthongtin").src=
"./assets/webcon-crystal/crystal-chinhsachbanhang.html";document.getElementById("audio1").src="./assets/crystal-audio/crystal-chinhsachbanhang.mp3";b.style.display="block"==b.style.display?"none":"block"},!1)}var m=d("app"),G=d("config"),x=d("data"),t=d("preloader"),H=d("version"),r=d("camera"),C=d("container"),g=d("controls"),h=d("scenes"),F=d("time"),l=d("transform"),k=d("vec3"),u="DEBUG"==H.type(),y=G.get_assets_path("phankhu-crystal"),p=!1,n=1,c={timeline:-1,starting_eye:new Float32Array(3),starting_target:new Float32Array(3),
final_eye:new Float32Array(3),final_target:new Float32Array(3),current_eye:new Float32Array(3),current_target:new Float32Array(3)},q=new Float32Array(3);v.init=function(){m.init({canvas_container_id:"main_canvas_container",callback:w,show_fps:u,console_verbose:u,autoresize:!0})}});b4w.require("crystal_main").init();
